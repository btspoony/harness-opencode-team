...
- Load timing for other skills (`mstar-plan-conventions`, `mstar-review-qc`, `mstar-routing-eval`, `mstar-coding-behavior`, `mstar-superpowers-align`) is governed by the `mstar-harness-core` skill index.
